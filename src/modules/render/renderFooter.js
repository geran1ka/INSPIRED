...
export const renderFooter = () => {
    ...
    for (const genderName in DATA.navigation) {
        let items = DATA.navigation[genderName].list;
        ...
        const footerCategorySubtitle = createElement('h3', {
            className: 'footer-category__subtitle',
        }, {
            parent: footerCategoryItem,
        })

        const footerCategorySubtitleLink = createElement('a', {
            className: 'footer__link',
            href: `#/${genderName}`,
            textContent: DATA.navigation[genderName].title,
        }, {
            parent: footerCategorySubtitle,
        }
        )
        const footerCategorySublist = createElement('ul', {
            className: 'footer-category__sublist',
        }, {
            parent: footerCategoryItem,
        })
        for (const item in items) {
        const footerCategorySubitem = createElement('li', {
            className: 'footer-category__subitem',
        }, {
            parent: footerCategorySublist,
            append: createElement('a', {
                className: 'footer__link',
                href: `#/${genderName}/${DATA.navigation[genderName].list[item].slug}`,
                textContent: DATA.navigation[genderName].list[item].title,
            })
        })
    }
};
    ...
    const footerSocialList = createElement('ul', {
        ...
        appends: [createElement('li', {
            ...
            append: createElement('a', {
                className: 'footer-social__link footer__link footer-social__link_vk',
                href: '#',
                innerHTML: `
            ...
            createElement('li', {
                ...
                append: createElement('a', {
                    className: 'footer-social__link footer__link footer-social__link_fb',
                    href: '#',
                    innerHTML: `
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
